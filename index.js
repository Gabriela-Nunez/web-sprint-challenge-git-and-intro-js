...
console.log('Task 6;', (artists, 'Gabriela Nunez', '1986-2022', 'Full Stack Development', 'Mexican', 'Do commodo elit nulla ut aliquip aute consequat labore est.'));
...
function artistByCountry(array, nationality){
  for(let i = 0; i < array.nationality.length; i++){
    array.push(array[i].nationality);
  }
  return array;
}
